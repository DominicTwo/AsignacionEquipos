...
<body>
    <section class="main-cards-sistemas">             
        ...
        <div class="card-content asignacion-card">
            ...
            <!-- Inicializamos en 0, el JS lo cambiará -->
            <p id="cant-asignaciones" class="count-asignaciones count-all"><?php echo $totalAsignaciones ?></p>
        </div>

        <div class="card-content cambio-card">
            <h2 class="title-card title-asignaciones">Cambios</h2>
            <p id="cant-cambios" class="count-cambios count-all"><?php echo $totalCambios ?></p>
        </div>
        
        <div class="card-content cancelacion-card">
            <h2 class="title-card title-asignaciones">Cancelaciones</h2>
            <p id="cant-cancelaciones" class="count-cancelaciones count-all"><?php echo $totalCancelaciones ?></p>
        </div>

        <div class="card-content bajas-card">
            <h2 class="title-card title-asignaciones">Bajas</h2>
            <p id="cant-bajas" class="count-bajas count-all"><?php echo $totalBajas ?></p>
        </div>
